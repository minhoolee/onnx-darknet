...
from onnx_darknet.darknet import darknet as dn
...
class DarknetBackend(Backend):
  ...
  def _onnx_graph_to_darknet_rep(cls, graph_def, opset, strict):
    ...
    #TODO: @m Need to make darknet_rep_graph class
    ...
    with tf_rep_graph.as_default():
      ...
      #TODO: @m Not necessary for me because Darknet doesn't have placeholders
      ...
      for value_info in graph_def.input:
        ...
        #     shape=shape)
        # TODO: @m set Darknet input
        dn.

        input_dict_items.append((value_info.name, x))

      #TODO: @m May not need tensor_dict; it's used for feeding session values
    ...
    dn_rep = DarknetRep()
    #TODO: @m Need to make darknet_rep_graph
    dn_rep.graph = dn_rep_graph
    dn_rep.inputs = [
        value_info.name
        for value_info in graph_def.input
  ...
  def _onnx_initializer_to_input_dict_items(cls, initializer):
    ...
    def tensor2list(onnx_tensor):
      ...
      # TODO: @m figure out if flatten() should be removed
