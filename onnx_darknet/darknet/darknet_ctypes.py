...
Darknet with GPU=1 and CUDNN=1, and moved to onnx_darknet/darknet/libdarknet.so
"""
# TODO(minhoolee): Figure out how to adjust ctypes structs depending on
# whether Darknet is installed with CPU, or GPU or GPU with CUDNN
