...
from onnx_darknet.common.handler_helper import get_frontend_coverage
from onnx_darknet.common.handler_helper import get_backend_coverage
...
def main():
  ...
  with open('opset_version.py', 'w') as version_file:
    ...
    version_file.write("frontend_darknet_opset_version = {\n " + pp.pformat(
